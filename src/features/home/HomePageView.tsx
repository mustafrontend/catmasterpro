    ...
    <div className="space-y-5 pb-8 animate-fade-in font-sans max-w-xl mx-auto">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-1.5 bg-amber-50/80 border border-amber-200/90 px-3 py-1.5 rounded-full shadow-2xs">
            ...
            <span className="text-xs font-black text-slate-800">
              {streak.currentStreak || 5} Day Streak
            </span>
          </div>
      ...
      >
        ...
        <div className="space-y-3 relative z-10">
          ...
          <h2 className="text-2xl font-black text-slate-900 tracking-tight font-serif">
            Today's Session with {activeCat ? activeCat.name : 'Milo'}
          </h2>

          <p className="text-xs text-slate-500 font-medium leading-relaxed max-w-sm">
            Manage your cat's training and health with 3-minute positive reinforcement sessions.
          </p>
          ...
          <div className="pt-1">
            ...
            >
              ...
              <span>Start 3-Min Session Now ⏰</span>
            </button>
          </div>
        </div>
      </motion.div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        ...
        >
          ...
          <span className="text-xs font-extrabold text-slate-800">Lessons</span>
        </button>
        ...
        >
          ...
          <span className="text-xs font-extrabold text-slate-800">Behavior</span>
        </button>
        ...
        >
          ...
          <span className="text-xs font-black text-[#97480d]">Kedi TV & Çağırıcı</span>
        </button>
        ...
        >
          ...
          <span className="text-xs font-extrabold text-[#97480d]">AI Mod</span>
        </button>
        ...
        >
          ...
          <span className="text-xs font-extrabold text-slate-800">Health</span>
        </button>
      </div>
